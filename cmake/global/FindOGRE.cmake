...
if (WIN32)
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_BITES_LIBRARY OGRE_CODECSTBI_LIBRARY OGRE_GLSUPPORT_LIBRARY
                                      ...
                                      OGRE_RENDERSYSTEMGL3PLUS_LIBRARY OGRE_RENDERSYSTEMGL_LIBRARY)
else()
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_GLSUPPORT_LIBRARY OGRE_BITES_LIBRARY OGRE_CODECSTBI_LIBRARY
                                      ...
                                      OGRE_RENDERSYSTEMGL_LIBRARY OGRE_CODECFREEIMAGE_LIBRARY)
endif()
...
if (OGRE_FOUND)
    if(WIN32 AND OGRE_RENDERSYSTEMD3D11_LIBRARY_DEBUG)
        ...
        list(APPEND OGRE_LIBRARIES ${OGRE_MAIN_LIBRARY} ${OGRE_HLMS_LIBRARY} ${OGRE_BITES_LIBRARY} ${OGRE_CODECSTBI_LIBRARY} ${OGRE_MESHLODGENERATOR_LIBRARY}
                                   ${OGRE_OVERLAY_LIBRARY} ${OGRE_PROPERTY_LIBRARY} ${OGRE_RTSHADERSYSTEM_LIBRARY} ${OGRE_GLSUPPORT_LIBRARY} ${OGRE_RENDERSYSTEMGL3PLUS_LIBRARY}
                                   ${OGRE_RENDERSYSTEMGL_LIBRARY})
        if(WIN32)
