...
set (FINDOGRE_VERSION 1.12.4)
if(${OGRE_NIX_MANUAL_BUILD} OR ${OGRE_NIX_PREBUILD})
...
if (WIN32)
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_CODECSTBI_LIBRARY OGRE_PARTICLEFX_LIBRARY OGRE_GLSUPPORT_LIBRARY
    ...
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_GLSUPPORT_LIBRARY OGRE_CODECSTBI_LIBRARY OGRE_PARTICLEFX_LIBRARY
...
if (OGRE_FOUND)
    if(WIN32 AND OGRE_RENDERSYSTEMD3D11_LIBRARY_DEBUG)
        ...
        list(APPEND OGRE_LIBRARIES ${OGRE_MAIN_LIBRARY} ${OGRE_HLMS_LIBRARY} ${OGRE_CODECSTBI_LIBRARY} ${OGRE_PARTICLEFX_LIBRARY} ${OGRE_OVERLAY_LIBRARY} ${OGRE_PROPERTY_LIBRARY}
