...
find_library(
    OGRE_PLUGINPFX_LIBRARY
    NAMES Plugin_ParticleFX${OGRE_LIB_PREFIX}
    PATHS
    $ENV{PROGRAMFILES}/lib
    ${OGRE_ROOT_DIR}/lib
    /usr/lib64
...
if (WIN32)
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_BITES_LIBRARY OGRE_CODECSTBI_LIBRARY
                                      OGRE_MESHLODGENERATOR_LIBRARY OGRE_OVERLAY_LIBRARY OGRE_PROPERTY_LIBRARY OGRE_PLUGINPFX_LIBRARY OGRE_RENDERSYSTEMD3D11_LIBRARY)
else()
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_GLSUPPORT_LIBRARY OGRE_BITES_LIBRARY OGRE_CODECSTBI_LIBRARY
                                      OGRE_MESHLODGENERATOR_LIBRARY OGRE_OVERLAY_LIBRARY OGRE_PROPERTY_LIBRARY OGRE_PLUGINPFX_LIBRARY OGRE_RENDERSYSTEMGL3PLUS_LIBRARY)
endif()
...
if (OGRE_FOUND)
	list(APPEND OGRE_LIBRARIES ${OGRE_MAIN_LIBRARY} ${OGRE_HLMS_LIBRARY} ${OGRE_GLSUPPORT_LIBRARY} ${OGRE_BITES_LIBRARY} ${OGRE_CODECSTBI_LIBRARY} ${OGRE_MESHLODGENERATOR_LIBRARY}
                               ${OGRE_OVERLAY_LIBRARY} ${OGRE_PROPERTY_LIBRARY} ${OGRE_PLUGINPFX_LIBRARY} ${OGRE_RENDERSYSTEMGL3PLUS_LIBRARY} ${OGRE_RENDERSYSTEMD3D11_LIBRARY})
