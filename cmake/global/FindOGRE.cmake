...
if (WIN32)
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_CODECSTBI_LIBRARY OGRE_GLSUPPORT_LIBRARY
    ...
    find_package_handle_standard_args(OGRE DEFAULT_MSG OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_GLSUPPORT_LIBRARY OGRE_CODECSTBI_LIBRARY
...
if (OGRE_FOUND)
    if(WIN32 AND OGRE_RENDERSYSTEMD3D11_LIBRARY_DEBUG)
        ...
        list(APPEND OGRE_LIBRARIES ${OGRE_MAIN_LIBRARY} ${OGRE_HLMS_LIBRARY} ${OGRE_CODECSTBI_LIBRARY} ${OGRE_OVERLAY_LIBRARY} ${OGRE_PROPERTY_LIBRARY}
	...
	set(OGRE_INCLUDE_DIRS ${OGRE_INCLUDE_DIR} ${OGRE_INCLUDE_DIR}/HLMS ${OGRE_INCLUDE_DIR}/MeshLodGenerator ${OGRE_INCLUDE_DIR}/Overlay
                          ${OGRE_INCLUDE_DIR}/Property ${OGRE_INCLUDE_DIR}/RTShaderSystem ${OGRE_INCLUDE_DIR}/Threading ${OGRE_INCLUDE_DIR}/Plugins/STBICodec
                          ${OGRE_INCLUDE_DIR}/RenderSystems/GL3Plus ${OGRE_INCLUDE_DIR}/RenderSystems/GL)
    if(WIN32)
...
# Hide some variables
mark_as_advanced(OGRE_INCLUDE_DIR OGRE_MAIN_LIBRARY OGRE_HLMS_LIBRARY OGRE_GLSUPPORT_LIBRARY OGRE_CODECSTBI_LIBRARY OGRE_OVERLAY_LIBRARY OGRE_PROPERTY_LIBRARY
                 OGRE_RTSHADERSYSTEM_LIBRARY OGRE_RENDERSYSTEMGL3PLUS_LIBRARY OGRE_RENDERSYSTEMD3D11_LIBRARY OGRE_MAIN_LIBRARY_DEBUG
                 ...
                 OGRE_RENDERSYSTEMGL3PLUS_LIBRARY_DEBUG OGRE_RENDERSYSTEMGL_LIBRARY OGRE_RENDERSYSTEMGL_LIBRARY_DEBUG)
